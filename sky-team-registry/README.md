...
* **Frontend:** JavaScript / Responsive HTML5 / Custom CSS3 (Interactive Dependency Graphs)
* **Version Control:** Git / Collaborative Peer Reviews via GitHub Feature Branches

## 📈 Core Business Value & Impact
* **Incident Mitigation:** Enables immediate discovery of on-call engineering teams and point-of-contact channels during high-priority production system down-times.
* **Legacy Migration:** Transitions clunky, manually updated administrative spreadsheets into a structured, real-time relational model.
* **Dependency Analysis:** Maps inter-team dependencies to prevent upstream bottlenecks during deployment planning cycles.

## 👥 My Engineering Contributions
While working alongside a collaborative engineering team on this platform, I personally designed and implemented:
